...
const newCycleFormSchema = zod.object({
  ...
  minutesAmount: zod.number().min(5).max(60, 'Informe no máximo 60 minutos'),
})
...
export function Home() {
  ...
  const { register, handleSubmit, watch, reset } = useForm<INewCycleForm>({
